...
namespace ArmyArranger.Models
{
    class AddWeaponsModel
    {
        ...
        public void AddWeapon(string name, String range, String shots, int penetration, bool requiresLoader, ObservableCollection<GameRule> rulesList)
        {
            try
            {
        ...
        public void UpdateWeapon(Weapon selectedWeapon, string name, String range, String shots, int penetration, bool requiresLoader, ObservableCollection<GameRule> rulesList)
        {
        ...
        public void ConfirmChanges(string name, String range, String shots, int penetration, bool requiresLoader, Weapon selectedWeapon, ObservableCollection<Weapon> weaponsList, ObservableCollection<GameRule> selectedRulesList)
        {
